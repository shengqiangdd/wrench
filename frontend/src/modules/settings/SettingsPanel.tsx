...
export default function SettingsPanel() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      {/* Header */}
      <div className="flex shrink-0 items-center gap-3 border-b border-slate-700/50 px-6 py-4">
        <Settings size={22} className="text-wrench-400" />
        <h1 className="text-lg font-semibold text-slate-200">设置</h1>
      </div>
