const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BLm2YPnF.js","assets/rolldown-runtime-b3L32Ng1.js","assets/vendor-lucide-wK0RyqBw.js","assets/vendor-router-C6ylH-cM.js","assets/vendor-state-BDyL0Ic5.js","assets/index-BTaecXSC.css"])))=>i.map(i=>d[i]);
import{r as G}from"./rolldown-runtime-b3L32Ng1.js";import{C as O,E as X,Et as I,It as W,Lt as D,Rt as J,U as q,_ as U,et as K,f as F,lt as B,n as H,o as V,tt as Y,ut as Q,x as Z}from"./vendor-lucide-wK0RyqBw.js";import{i as ee}from"./vendor-router-C6ylH-cM.js";import{a as te,i as $,r as z}from"./index-BLm2YPnF.js";import{n as se}from"./websocket-PwStSdX1.js";var r=G(J(),1);async function ae(){try{const n=await fetch("/api/plugins");if(!n.ok)throw new Error(`HTTP ${n.status}: ${n.statusText}`);return(await n.json()).plugins||[]}catch(n){return console.error("[PluginManager] Failed to fetch plugins:",n),[]}}async function ne(n){const b=await fetch(n);if(!b.ok)throw new Error(`Failed to load plugin JS: HTTP ${b.status}`);return await b.text()}function re(n){z.getState().unregisterPlugin(n),$.unregister(n)}var e=te(),A=null;function M(){return A||ee(()=>import("./index-BLm2YPnF.js").then(n=>n.t).then(n=>{A=n.useFileStore}),__vite__mapDeps([0,1,2,3,4,5])),A}function le({manifest:n,pluginCode:b,onReady:d,onCommandRegistered:k,onPanelRegistered:j,onNotification:S,onError:p,editorContent:R,editorLanguage:P}){const m=(0,r.useRef)(null),[_,C]=(0,r.useState)(!1),[L,N]=(0,r.useState)(!0),[w,E]=(0,r.useState)(null);(0,r.useRef)(new Map);const T=(0,r.useRef)(null),h=(0,r.useRef)(null),s=(0,r.useRef)(!1),i=(0,r.useCallback)(()=>{const a=`
      <style>
